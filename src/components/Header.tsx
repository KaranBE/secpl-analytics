      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          ...
          {onOpenShare && (
            <button
              type="button"
              id="header-share-analytics-btn"
              onClick={onOpenShare}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 hover:text-indigo-600 text-xs font-semibold shadow-2xs transition-colors cursor-pointer"
              title="Share analytics with another email address"
            >
